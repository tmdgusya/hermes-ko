      ...
      <div className="max-w-6xl mx-auto">
        <div className="max-w-3xl mb-12">
          ...
          <div className="mb-5 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-hermes-primary/10">
              <HelpCircle className="h-6 w-6 text-hermes-primary" />
            </div>
          ...
          <p className="text-lg text-text-secondary leading-relaxed">
            질문은 GitHub Issue로 저장하고, 이 페이지에서는 <span className="text-text-primary">라벨</span>로
