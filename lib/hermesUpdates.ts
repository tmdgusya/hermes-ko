...
export const hermesUpdates: HermesUpdate[] = [
  ...
  {
    date: "2026-05-01",
    title: "Agent guardrails 강화, 압축 토큰 추정, DeepSeek V4 Pro 보정 및 /goal 크로스턴 목표",
    category: "Agent 안정성",
    summary:
      "도구 호출 반복 루프를 감지하는 guardrail이 warning-first 방식으로 추가됐습니다. 압축 시 시스템 프롬프트와 도구 스키마를 토큰 추정에 포함하도록 수정됐으며, DeepSeek V4 Pro thinking mode에서 reasoning_content placeholder가 비어있지 않도록 보정됐습니다. 크로스턴 목표를 유지하는 /goal 기능(Ralph loop)도 도입됐습니다.",
    commits: [
      {
        sha: "58b8996",
  ...
  {
    date: "2026-05-01",
    title: "Gateway snapshot·슬래시 알림 TTL·boolean 보정 및 State replay finish_reason",
    category: "Gateway / State",
    summary:
      "Gateway 콜백 snapshot 시점이 agent bind 이후로 조정되고, slash command 시스템 알림이 TTL 기반으로 자동 삭제됩니다. tool_progress_command와 StreamingConfig의 boolean 값이 안전하게 보정되며, conversation replay에 finish_reason이 포함됩니다.",
    commits: [
      {
        sha: "8d7500d",
  ...
  {
    date: "2026-05-01",
    title: "Config boolean 보정, atomic 저장, 경로 정규화, YOLO 모드 파싱 및 update --yes 플래그",
    category: "Config / Auth",
    summary:
      "문자열로 들어오는 설정값을 실제 boolean으로 보정하고, provider config 저장을 atomic write로 전환해 설정 파일 손상을 방지합니다. achievements plugin과 profile-tui 경로가 HERMES_HOME 기준으로 라우팅됩니다. YOLO 모드 환경변수 파싱이 quoted-bool 문자열에 대해 강화됐으며, hermes update에 --yes/-y 플래그가 추가돼 대화형 프롬프트를 건너뛸 수 있습니다.",
    commits: [
      {
        sha: "27ec74c",
  ...
  {
    date: "2026-05-01",
    title: "Yuanbao·Discord·Moonshot 도구 수정 및 Browser Supervisor 헬스 체크",
    category: "Tools / MCP / Plugins",
    summary:
      "Yuanbao 그룹 slash command에 owner identity 검사가 적용되고, Discord 툴의 capability 캐시가 토큰별로 분리됩니다. Moonshot anyOf collapse 후 nullable/enum 제거와 missing type 보완이 적용됐으며, browser_supervisor에서 캐시된 supervisor를 반환하기 전 thread와 loop 상태를 확인하도록 수정됐습니다.",
    commits: [
      {
        sha: "b7ad3f4",
